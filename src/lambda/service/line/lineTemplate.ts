import { Action, FlexBox, FlexBubble, FlexBubbleStyle, FlexCarousel, FlexImage, TemplateButtons, TemplateConfirm} from '@line/bot-sdk';
...
export const ConfirmTemplate =(text:string, actions:Action[]):TemplateConfirm=>{
    return {
        type:"confirm",
        text:text,
        actions:actions
